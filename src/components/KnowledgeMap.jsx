...
export default function KnowledgeMap({ kmap, onToggle }) {
  const lv = (s) => kmap[s] || 0
    ...
    <div className="fade-in">
      <div style={{ marginBottom: 36 }}>
        ...
        <p style={{ color: '#475569', fontSize: 14, maxWidth: 540, lineHeight: 1.7 }}>
          Click each service to cycle your proficiency level. Be honest — the AI recommendation improves with accuracy.
        </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
        {Object.entries(SERVICES).map(([cat, svcs]) => (
          <div key={cat}>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: '0.18em', color: '#334155', marginBottom: 12, textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 8 }}>
